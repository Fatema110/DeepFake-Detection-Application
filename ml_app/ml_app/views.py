...
class Model(nn.Module):
    ...
    def __init__(self, num_classes,latent_dim= 2048, lstm_layers=1 , hidden_dim = 2048, bidirectional = False):      #ENCODER
...
class validation_dataset(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        for i,frame in enumerate(self.frame_extract(video_path)):
            ...
            try:
              top,right,bottom,left = faces[0]   #taking location of each face of image
              frame = frame[top:bottom,left:right,:] #access the actual face
            except:
              pass
